...
async def update_repo(_, message: Message):
    ...
    msg = await message.reply("🔄 `تتم البرمجه بواسطة تيليمكس ميوزك......`")
    ...
    if update_avail:
        ...
        return
    await msg.edit(f"تم الترقية بواسطه سورس [Tᥱᥣᥱꪔᥱꪎ Mᥙ᥉Ꭵᥴ](https://t.me/source_Telemex)", disable_web_page_preview=True)
